               ...
               map_file(map_file), load_map(load_map)
{
    ...
    // load serialized map
     if (load_map && LoadMap(map_file)) {
        ...
        trackframe<<"NonTracking Frame Num: "<< mpMap->GetNframe()<<" Actual Tracking Frame Num: "<< mpMap->GetTframe()<<" Global BA Num: "<<mpMap->GetGnum()<<" All Frame Num: "<<mpMap->GetFframe()<<" Loop closing Num: "<<mpMap->GetCnum()<<" Relocalization Num: "<<mpMap->GetRnum()<<"\n";
        trackframe.close();
