...
void KeyFrame::UpdateBestCovisibles()
{
    ...
    for(map<KeyFrame*,int>::iterator mit=mConnectedKeyFrameWeights.begin(), mend=mConnectedKeyFrameWeights.end(); mit!=mend; mit++)
    {
        vPairs.push_back(make_pair(MakeFinalWeight(mit->second,mit->first->GetGPSData()),mit->first));
...
void KeyFrame::UpdateConnections()
{
    ...
    {
        double distance = GetDistanceWithGPS(mit->first->GetGPSData());
        int finalWeight = MakeFinalWeight(mit->second,mit->first->GetGPSData());
        ...
        if(mit->second>=thW && distance>=thD)
        {
            ...
            // Addconection
            (mit->first)->AddConnection(this,mit->second, mkGPS);
        }
    ...
    if(vPairs.empty())
    {
        ...
        pKFmax->AddConnection(this,Wmax, mkGPS);
...
int KeyFrame::MakeFinalWeight(int weight, std::pair<double, double> mGPS)
{
...
double KeyFrame::GetDistanceWithGPS(std::pair<double, double> mGPS)
{
